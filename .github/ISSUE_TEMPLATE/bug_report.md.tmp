---
name: Bug report
about: Provider is not behaving as expected, Please make sure this is a provider problem and NOT a docker/transmission problem
title: ''
labels: 'bug'
assignees: ''
...
- [ ] Searched for [provider issues][si] and [container issues][ci]
...
### VPN Provider
<!-- Please post the provider you are using -->
**Required, problem occurs with :** 
<!-- Provider name --> 
```<placeholder>```
